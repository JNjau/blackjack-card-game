...
def _deal_card(frame):
    # pop the next card of the top of the card
    next_card = deck.pop(0)
    # and add it to the back of the pack
    deck.append(next_card)
    # add the image to a label to display the label
...
def score_hand(hand):
    # calculate the total score of all cards on the list
...
mainWindow.configure(background='pink')
...
# and add the number of decks to play with
